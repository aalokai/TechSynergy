    ...
    <head>
        ...
        <script>
            function validate() {
                ...
                if (confirm_password.value.trim() === "" || confirm_password.value === null) {
                ...
                if (usertype.value.trim() === "" || usertype.value === null) {
                    alert('Please select user type');
                    usertype.focus();
                    return false;
                }
                if (gender.value.trim() === "" || gender.value === null) {
                    alert('Please select gender');
                    gender.focus();
                    return false;
                }
                if (contact_number.value.trim() === "" || contact_number.value === null) {
                    alert('Please enter contact number');
                    contact_number.focus();
                    return false;
                }
                if (skills.value.trim() === "" || skills.value === null) {
                ...
                if (languages.value.trim() === "" || languages.value === null) {
                    alert('Please enter languages');
                    languages.focus();
                    return false;
                }
                if (bio.value.trim() === "" || bio.value === null) {
                    alert('Please enter bio/qualifications');
                    bio.focus();
                    return false;
                }
                if (portfolio.value.trim() === "" || portfolio.value === null) {
            ...
            <div class="row justify-content-center" >
                ...
                <div class="col-md-8 col-lg-6 my-5 px-5 pt-lg-5 pt-md-4 ">
                    ...
                    <form id="frmregister" class="form-group " method="post"
                        ...
                        <div class="mb-3">
                            <label for="portfolio" class="form-label">Portfolio/Projects link</label>
